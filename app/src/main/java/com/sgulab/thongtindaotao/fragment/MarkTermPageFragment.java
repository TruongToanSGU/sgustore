...
public class MarkTermPageFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_term_mark_page, container, false);
    }
    ...
    public static Fragment newInstance(MarkTerm term) {
        MarkTermPageFragment f = new MarkTermPageFragment();
